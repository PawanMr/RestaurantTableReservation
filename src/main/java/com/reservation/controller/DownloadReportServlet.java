    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            for (Reservation res : allReservations) {
                ...
                if ("Approved".equalsIgnoreCase(res.getStatus())) statusColor = new BaseColor(34, 139, 34);
                else if ("Pending".equalsIgnoreCase(res.getStatus())) statusColor = new BaseColor(204, 102, 0);
                else if ("Cancelled".equalsIgnoreCase(res.getStatus())) statusColor = new BaseColor(220, 53, 69);
